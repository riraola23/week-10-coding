...
document.getElementById('add').addEventListener('click', () => { // "add" button on html. when click, 
    ...
    row.insertCell(0).innerHTML = document.getElementById('dog-breed').value;
    ...
    row.insertCell(2).innerHTML = document.getElementById('drop-off-date').value;
    row.insertCell(3).innerHTML = document.getElementById('pick-up-date').value;
    row.insertCell(4).innerHTML = document.getElementById('allergies').value;
